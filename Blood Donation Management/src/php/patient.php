...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['patient'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($check != 'pending') {
                $sql = "INSERT INTO `patient` (username, name, phonenumber, dateofbirth, age, address, purpose, gender, bloodgroup, timestamp, status) VALUES ('$username', '$name', '$phonenumber', '$dateofbirth', '$age', '$address','$purpose', '$gender', '$bloodgroup', '$timestamp', 'pending')";
...
<body>
    <div class="main-block">
        <div class="left-part">
            ...
            <h1>Fill up the form to request Blood</h1>
            <p>Spare only 15 minutes and save one life</p>
        </div>
        <form action="patient.php" method="post">
            <div class="title">
                <i class="fas fa-pencil-alt"></i>
                <h2>Request blood here</h2>
            </div>
            <div class="info">
            ...
            <button type="submit" name="patient">Request</button>
        </form>
    </div>
</body>
